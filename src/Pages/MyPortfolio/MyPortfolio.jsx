...
export default function MyPortfolio() {
  return (
    <section className={classes["portfolio-section"]} id="MyPortfolio">
      <div className={classes["portfolio-section__box"]}>
        <div className={classes["portfolio-section__container--toplevel"]}>
      ...
      <div className={classes["portfolio-section__container--bottomlevel"]}>
        {data?.portfolios?.map((portfolio) => {
          return (
            <div
              key={portfolio.id}
              className={classes["portfolio-section__card"]}
            >
              <div className={classes["portfolio-section__img"]}>
                <img src={portfolio.src} alt="project screenshot" />
              </div>
              <div className={classes["portfolio-section__card__content"]}>
                <div>
                ...
                <p className={classes["portfolio-section__card__link"]}>
                  {portfolio.link}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
